...
SENDER_EMAIL = '224g1a0516@srit.ac.in' # Your Gmail address
SENDER_PASSWORD = 'nzxi pgmx quij mpcv' # Your Gmail App Password (NOT your regular password if 2FA is on)
RECEIVER_EMAIL = '224g1a0516@srit.ac.in' # The email address where you want to receive feedback
